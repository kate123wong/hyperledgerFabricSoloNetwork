...
URL=192.168.0.102
echo "$(json_ccp $ORG $P0PORT $P1PORT $CAPORT $PEERPEM $CAPEM $URL)" > connection-org1.json
...
URL=192.168.0.103
echo "$(json_ccp $ORG $P0PORT $P1PORT $CAPORT $PEERPEM $CAPEM $URL)" > connection-org2.json
